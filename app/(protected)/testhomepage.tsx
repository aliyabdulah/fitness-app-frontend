      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.greetingSection}>
            <Text style={styles.greeting}>Welcome to the homepage
Hello, Ahmed! 👋</Text>
        ...
        <View style={styles.navigationContainer}>
          ...
          >
            {[
              { id: 'home', title: 'Home', icon: '🏠', active: true },
              { id: 'schedule', title: 'Schedule', icon: '📅', active: false },
              { id: 'train', title: 'Train', icon: '💪', active: false },
              { id: 'explore', title: 'Explore', icon: '🔍', active: false },
              { id: 'analytics', title: 'Analytics', icon: '📊', active: false },
            ].map((item) => (
              <TouchableOpacity
                key={item.id}
                style={[
          ...
          >
            <View style={styles.workoutHeader}>
              ...
              <View style={styles.workoutInfo}>
                ...
                <Text style={styles.workoutDuration}>45 min • 2:30 PM</Text>
              </View>
        ...
        <View style={styles.trainersSection}>
          ...
          >
            {[
              { name: 'Sarah Johnson', specialty: 'Strength Training', rating: '4.9', image: '👩‍🦱' },
              { name: 'Mike Chen', specialty: 'Cardio & HIIT', rating: '4.8', image: '👨‍🦰' },
              { name: 'Lisa Park', specialty: 'Yoga & Flexibility', rating: '4.9', image: '👩‍🦳' },
            ].map((trainer, index) => (
              <TouchableOpacity 
                key={index}
        ...
        <View style={styles.quickActionsSection}>
          ...
          <View style={styles.quickActionsGrid}>
            {[
              { title: 'Log Workout', icon: '📝', color: Colors.primary },
              { title: 'Find Equipment', icon: '🏋️', color: '#4ECDC4' },
              { title: 'Book Trainer', icon: '👥', color: '#45B7D1' },
              { title: 'View Progress', icon: '📈', color: '#96CEB4' },
            ].map((action, index) => (
              <TouchableOpacity
                key={index}
